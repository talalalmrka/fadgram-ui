...
<template>
    <component :is="sectionTag" class="VPSidebarItem" :class="classes">
        <div v-if="item.text" class="item" :role="itemRole" v-on="item.items
            ...
            <VPLink v-if="item.link" :tag="linkTag" class="link" :href="item.link" :rel="item.rel"
                :target="item.target">
                <i v-if="item.icon" class="icon" :class="item.icon" aria-hidden="true"></i>
                <component :is="textTag" class="text" v-html="item.text" />
            </VPLink>
            <div v-else class="link">
                <i v-if="item.icon" class="icon" :class="item.icon" aria-hidden="true"></i>
                <component :is="textTag" class="text border-dotted-red" v-html="item.text" />
            </div>
